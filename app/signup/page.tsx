  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-container">
        ...
        <div className="auth-form-section">
          <div className="auth-form-card glass-card">
            ...
            <button className="google-btn" onClick={() => { setLoading(true); setTimeout(() => router.push('/dashboard'), 1000); }}>
            ...
            <form onSubmit={handleSignup}>
              <div className="field"><div className="field-icon"><User size={16} /></div><input className="input-field" placeholder="Full name" value={name} onChange={(e) => setName(e.target.value)} required style={{ paddingLeft: 40 }} /></div>
              <div className="field"><div className="field-icon"><Mail size={16} /></div><input type="email" className="input-field" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} required style={{ paddingLeft: 40 }} /></div>
              <div className="field">
                <div className="field-icon"><Lock size={16} /></div>
                <input type={showPassword ? 'text' : 'password'} className="input-field" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} required style={{ paddingLeft: 40, paddingRight: 40 }} />
              ...
              <div className="field"><div className="field-icon"><Lock size={16} /></div><input type="password" className="input-field" placeholder="Confirm password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required style={{ paddingLeft: 40 }} /></div>
              ...
              <button type="submit" className="btn-primary submit-btn" disabled={loading || !agreed || password !== confirmPassword}>
      ...
      <style jsx>{`
        ...
        .strength-bar { display: flex; align-items: center; gap: 8px; margin-bottom: 12px; }
        .strength-bar > div:first-child { flex: 1; height: 4px; background: var(--bg-surface); border-radius: 2px; overflow: hidden; }
